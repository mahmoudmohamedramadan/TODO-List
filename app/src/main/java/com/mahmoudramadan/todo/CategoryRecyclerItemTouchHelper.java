...
public class CategoryRecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {

    private CategoryAdapter adapter;
    private boolean isSwipedLeft = false;

    public CategoryRecyclerItemTouchHelper(CategoryAdapter adapter) {
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if (isSwipedLeft) {
            ...
            builder.setTitle(viewHolder.itemView.getContext().getString(R.string.delete_category));
            builder.setMessage(viewHolder.itemView.getContext().getString(R.string.delete_category_message));
